...
extension RoundView {
    func initTimer() {
        if (timer == nil) {
            timer = NSTimer.scheduledTimerWithTimeInterval(5, target: self, selector: "timerAction", userInfo: nil, repeats: true)
        }
    }
...
extension RoundView : UICollectionViewDataSource {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        imageView.image = UIImage(named: self.imageList[index])
